...
Круги часто используются для создания отверстий либо с помощью карманов, либо с помощью специального инструмента отверстий. Хотя последний не использует значение радиуса, вы, тем не менее, должны полностью ограничить свои эскизы.
...
\end{itemize}
Теперь внутренний квадрат изменил свой цвет на синий, указывая на то, что это вспомогательные линии, которые не влияют на какие-либо элементы на основе эскиза, такие как прокладки или карманы.
